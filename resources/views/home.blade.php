    ...
    <div id="page" class="s-pagewrap">
        ...
        <section id="intro" class="s-intro target-section">
            ...
            <ul class="s-intro__social social-list">
                <li>
                    <a href="https://x.com/mxhul09?t=C9T4OEtSBk8FZE9ykNBzjQ&s=09">
                ...
                <li>
                    <a href="https://www.instagram.com/thmehul18?igsh=MmxvMWM0empwamlm">
                ...
                <li>
                    <a href="https://github.com/mxhul-22">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">
                            <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.54 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.83-.01-1.51-2.01.44-2.43-.49-2.59-.94-.09-.22-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.86 2.32.66.07-.52.28-.86.5-1.06-1.74-.2-3.56-.87-3.56-3.88 0-.86.31-1.57.82-2.12-.08-.2-.36-1 .08-2.09 0 0 .66-.21 2.15.82A7.47 7.47 0 018 3c1 .004 2 .14 2.93.41 1.49-1.03 2.15-.82 2.15-.82.44 1 .16 1.89.08 2.09a2.5 2.5 0 01.82 2.12c0 3-1.83 3.68-3.56 3.88a1.51 1.51 0 01.43 1c0 .73-.01 1.32-.01 1.5a1 .998 0 00.55 .38C13.71 14.54 16 11.54 16 8c0-4.42-3.58-8-8-8z"/>
                          </svg>
            ...
            <div class="s-intro__btn-download">
                <a class="btn btn--stroke" href="https://drive.google.com/file/d/1cWXp5Jyvsys7-tKxusjIm_cvGV3PYY1L/view?usp=drive_link">Get My CV</a>
